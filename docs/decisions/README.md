...
| [ADR-0007: Parser Runtime State Decomposition Strategy](ADR-0007-parser-runtime-state-decomposition-strategy.md) | Proposed | Parser runtime state decomposition proceeds through one behavior-preserving state-cluster extraction at a time, with PostingState as the first pilot pattern. |
