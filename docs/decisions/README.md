...
| [ADR-0012: Long-Horizon Context And Delegation Discipline](ADR-0012-long-horizon-context-and-delegation-discipline.md) | Proposed | Material transitions refresh current authority; delegation and parallel writes remain bounded evidence mechanisms rather than authority. |
