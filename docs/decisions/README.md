...
| [ADR-0006: Repository Boundary Strategy](ADR-0006-repository-boundary-strategy.md) | Proposed | Keep Mythic Edge monorepo-first while defining safe future boundaries for Parser, Corpus / Provenance, Analytics, Local App / UI, Workbook / Transport, Quality / Governance, and future AI Integration. |
