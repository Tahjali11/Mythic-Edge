...
| [ADR-0008: Repo WIP-1 Lane Activation Policy](ADR-0008-repo-wip-1-lane-activation-policy.md) | Proposed | Each Mythic Edge repository defaults to one active issue or lane, with named, scoped, expiring exceptions. |
