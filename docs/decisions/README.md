...
| [ADR-0006: Repository Boundary Strategy](ADR-0006-repository-boundary-strategy.md) | Proposed | Keep Mythic Edge monorepo-first while defining safe future boundaries for corpus, parser, analytics, advisor, workflow, and app orchestration repositories. |
