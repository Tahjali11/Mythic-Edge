...
| [ADR-0008: Repo WIP-1 Lane Activation Policy](ADR-0008-repo-wip-1-lane-activation-policy.md) | Accepted | Each Mythic Edge repository defaults to one active issue or lane, with named, scoped, expiring exceptions. |
| [ADR-0009: Optional Dependency Provider Model](ADR-0009-optional-dependency-provider-model.md) | Proposed | Base Mythic Edge stays complete without optional providers; future providers extend base-owned interfaces without owning upstream truth. |
| [ADR-0010: Bounded Scope And Informed Approval](ADR-0010-bounded-scope-and-informed-approval.md) | Proposed | Clear low-risk requests proceed without duplicate confirmation while consequential authority remains exact, informed, bounded, and gate-specific. |
| [ADR-0011: Role-Scoped Protected Mutations](ADR-0011-role-scoped-protected-mutations.md) | Proposed | Protected-surface classification follows the semantic effect and current role without weakening ADR-0004's authorization or forbidden-effect gates. |
| [ADR-0012: Long-Horizon Context And Delegation Discipline](ADR-0012-long-horizon-context-and-delegation-discipline.md) | Accepted | Material transitions refresh current authority; delegation and parallel writes remain bounded evidence mechanisms rather than authority. |
