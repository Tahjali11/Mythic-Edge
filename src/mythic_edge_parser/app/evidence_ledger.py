...
_OUTPUT_FAMILIES: tuple[dict[str, Any], ...] = (
    ...
    },
    {
        ...
        "seed_fields": ["diagnostics_status", "unknown_entry_count", "truncation_count"],
        "future_fields": [],
        "owner_modules": [
        ...
        "notes": [
            "Issue #171 maps diagnostics_status, unknown_entry_count, and truncation_count provenance only.",
            "Diagnostics status remains advisory local report evidence, not CI, merge, deploy, tracker, "
            "workbook, transport, analytics, model-provider, or AI truth.",
            "Unknown-entry counts are scoped to the analyzed input; unknown signatures and unmatched API names "
            "remain review samples, not trusted parser inputs.",
            "Truncation counts prove observed GameState data-loss markers only and do not reconstruct missing "
            "GameState payloads.",
            "Golden replay and feature-equity reports are validation/report consumers only.",
            "This does not change diagnostics behavior, drift behavior, router semantics, truncation parsing, "
            "runtime status schema, replay behavior, feature-equity behavior, CI gates, merge/deploy policy, "
            "workbook sync, analytics, AI, or field-evidence attachment behavior.",
        ],
    },
    {
        "tier": 7,
...
_DIAGNOSTICS_STATUS_ENTRY: dict[str, Any] = {
    "entry_id": "tier6.runtime_health_and_drift_detection.diagnostics_status",
    "tier": 6,
    "output_family": "runtime_health_and_drift_detection",
    "output_field": "diagnostics_status",
    "display_name": "Diagnostics Status",
    "parser_owner": "src/mythic_edge_parser/app/parser_diagnostics.py",
    "model_surface": "parser_diagnostics_report.overall_status",
    "downstream_surfaces": [
        "parser_diagnostics_report",
        "golden_replay_report",
        "feature_equity_corpus_report",
        "future_runtime_health_consumers",
    ],
    "parser_managed_truth": True,
    "coverage_status": "seeded_sample",
    "direct_evidence": [
        {
            "signal_id": "parser_diagnostics.diagnostics_status.overall_status",
            "parser_event_kind": "parser_diagnostics",
            "parser_event_type": "parser_diagnostics.v1",
            "raw_event_family": "local_diagnostics_report",
            "raw_message_type": "",
            "normalized_payload_path": "overall_status",
            "raw_payload_path": "parser diagnostics report overall_status",
            "required_for_final": True,
            "value_source_when_used": "derived",
            "confidence_when_used": "high",
            "finality_when_used": "final",
            "allowed_types": ["str"],
            "missing_behavior": "missing diagnostics overall status leaves diagnostics_status unknown",
            "privacy_class": "path_only_no_values",
        },
        {
            "signal_id": "parser_diagnostics.diagnostics_status.summary_parser_status",
            "parser_event_kind": "parser_diagnostics",
            "parser_event_type": "parser_diagnostics.v1",
            "raw_event_family": "local_diagnostics_report",
            "raw_message_type": "",
            "normalized_payload_path": "summary.parser_status",
            "raw_payload_path": "parser diagnostics report summary.parser_status",
            "required_for_final": False,
            "value_source_when_used": "derived",
            "confidence_when_used": "high",
            "finality_when_used": "final",
            "allowed_types": ["str"],
            "missing_behavior": "missing parser-status summary lowers confidence but does not invent status",
            "privacy_class": "path_only_no_values",
        },
        {
            "signal_id": "parser_diagnostics.diagnostics_status.parser_health_status",
            "parser_event_kind": "parser_diagnostics",
            "parser_event_type": "parser_diagnostics.v1",
            "raw_event_family": "local_diagnostics_report",
            "raw_message_type": "",
            "normalized_payload_path": "parser_health.status",
            "raw_payload_path": "parser diagnostics report parser_health.status",
            "required_for_final": False,
            "value_source_when_used": "derived",
            "confidence_when_used": "high",
            "finality_when_used": "final",
            "allowed_types": ["str"],
            "missing_behavior": "missing parser-health status leaves diagnostics status weaker",
            "privacy_class": "path_only_no_values",
        },
    ],
    "fallback_evidence": [
        {
            "signal_id": "parser_diagnostics.diagnostics_status.section_statuses",
            "parser_event_kind": "parser_diagnostics",
            "parser_event_type": "parser_diagnostics.v1",
            "raw_event_family": "local_diagnostics_report",
            "raw_message_type": "",
            "normalized_payload_path": (
                "parser_health.status + truncation_and_data_loss.status + "
                "unknowns_and_degradation.status + transport_health.status"
            ),
            "raw_payload_path": "parser diagnostics report section statuses",
            "required_for_final": False,
            "value_source_when_used": "derived",
            "confidence_when_used": "medium",
            "finality_when_used": "final",
            "allowed_types": ["str", "dict"],
            "missing_behavior": "contradictory or incomplete section statuses require review",
            "privacy_class": "path_only_no_values",
        },
        {
            "signal_id": "diagnostics.runtime_health.operational_status_context",
            "parser_event_kind": "runtime_surface",
            "parser_event_type": "diagnostics_runtime_status",
            "raw_event_family": "local_runtime_surface",
            "raw_message_type": "",
            "normalized_payload_path": "diagnostics runtime status and error counters",
            "raw_payload_path": "diagnostics runtime status artifact paths",
            "required_for_final": False,
            "value_source_when_used": "derived",
            "confidence_when_used": "medium",
            "finality_when_used": "provisional",
            "allowed_types": ["dict"],
            "missing_behavior": "missing optional runtime status is not a parser failure",
            "privacy_class": "path_only_no_values",
        },
    ],
    "value_source_policy": {
    ...
    "invariant_checks": [
        "tier6_seeds_exactly_diagnostics_status_unknown_entry_count_and_truncation_count",
        "tier6_future_fields_empty_after_runtime_health_seed",
    ...
    "degradation_behavior": [
        "unreadable source log or invalid diagnostics profile leaves diagnostics_status unknown",
        "diagnostics replay failure, parser exception, or router exception lowers confidence and requires review",
        "unknown-heavy evidence or truncation/data-loss evidence can make diagnostics status review or fail",
        "malformed optional runtime status lowers fallback confidence but is not parser truth",
        "transport, workbook, Apps Script, deployment, merge, CI, analytics, model-provider output, and AI "
        "must not populate diagnostics_status truth",
    ],
    "drift_flags": [
        "missing_expected_event_family",
        "new_unknown_event_family",
    ...
    "fixture_refs": [],
    "notes": [
        "Issue #171 documents diagnostics_status provenance without changing diagnostics report shape or CLI behavior.",
        "diagnostics_status is derived from one local diagnostics report snapshot and remains advisory.",
        "A pass status is not full parser correctness, CI truth, merge readiness, deploy readiness, workbook truth, "
        "transport truth, analytics truth, model-provider truth, or AI truth.",
    ],
}


_UNKNOWN_ENTRY_COUNT_ENTRY: dict[str, Any] = {
    "entry_id": "tier6.runtime_health_and_drift_detection.unknown_entry_count",
    "tier": 6,
    "output_family": "runtime_health_and_drift_detection",
    "output_field": "unknown_entry_count",
    "display_name": "Unknown Entry Count",
    "parser_owner": "src/mythic_edge_parser/app/log_drift_sensor.py",
    "model_surface": "parser_health.entry_counts.unknown / drift_report.entry_counts.unknown",
    "downstream_surfaces": [
        "parser_diagnostics_report",
        "log_drift_report",
        "golden_replay_report",
    ...
    "direct_evidence": [
        {
            "signal_id": "parser_diagnostics.unknown_entry_count.summary_unknown_entries",
            "parser_event_kind": "parser_diagnostics",
            "parser_event_type": "parser_diagnostics.v1",
            "raw_event_family": "local_diagnostics_report",
            "raw_message_type": "",
            "normalized_payload_path": "summary.unknown_entries",
            "raw_payload_path": "parser diagnostics report summary.unknown_entries",
            "required_for_final": False,
            "value_source_when_used": "derived",
            "confidence_when_used": "high",
            "finality_when_used": "final",
            "allowed_types": ["int"],
            "missing_behavior": "missing unknown summary leaves unknown_entry_count unknown",
            "privacy_class": "path_only_no_values",
        },
        {
            "signal_id": "parser_diagnostics.unknown_entry_count.parser_health_entry_counts_unknown",
            "parser_event_kind": "parser_diagnostics",
            "parser_event_type": "parser_diagnostics.v1",
            "raw_event_family": "local_diagnostics_report",
            "raw_message_type": "",
            "normalized_payload_path": "parser_health.entry_counts.unknown",
            "raw_payload_path": "parser diagnostics report parser_health.entry_counts.unknown",
            "required_for_final": True,
            "value_source_when_used": "derived",
            "confidence_when_used": "high",
            "finality_when_used": "final",
            "allowed_types": ["int"],
            "missing_behavior": "missing parser-health count leaves unknown_entry_count unknown",
            "privacy_class": "path_only_no_values",
        },
        {
            "signal_id": "log_drift_sensor.unknown_entry_count.entry_counts_unknown",
            "parser_event_kind": "log_drift_sensor",
            "parser_event_type": "player_log_drift_report.v1",
            "raw_event_family": "local_drift_report",
            "raw_message_type": "",
            "normalized_payload_path": "entry_counts.unknown",
            "raw_payload_path": "drift report entry_counts.unknown",
            "required_for_final": False,
            "value_source_when_used": "derived",
            "confidence_when_used": "high",
            "finality_when_used": "final",
            "allowed_types": ["int"],
            "missing_behavior": "missing drift report count leaves diagnostics summary as the source",
            "privacy_class": "path_only_no_values",
        },
        {
            "signal_id": "router_stats.unknown_entry_count.unknown",
            "parser_event_kind": "router_stats",
            "parser_event_type": "RouterStats",
            "raw_event_family": "router_stats",
            "raw_message_type": "",
            "normalized_payload_path": "RouterStats.unknown",
            "raw_payload_path": "router stats unknown count",
            "required_for_final": False,
            "value_source_when_used": "derived",
            "confidence_when_used": "high",
            "finality_when_used": "final",
            "allowed_types": ["int"],
            "missing_behavior": "missing router stats leaves report-level count as the source",
            "privacy_class": "path_only_no_values",
        },
    ],
    "fallback_evidence": [
        {
            "signal_id": "log_drift_sensor.unknown_entry_count.review_samples",
            "parser_event_kind": "log_drift_sensor",
            "parser_event_type": "player_log_drift_report.v1",
            "raw_event_family": "local_drift_report",
            "raw_message_type": "",
            "normalized_payload_path": (
                "top_unknown_signatures + top_unmatched_api_names + "
                "top_unmatched_request_api_names + baseline_delta.new_unknown_signatures"
            ),
            "raw_payload_path": "drift report review sample paths",
            "required_for_final": False,
            "value_source_when_used": "derived",
            "confidence_when_used": "low",
            "finality_when_used": "provisional",
            "allowed_types": ["list", "dict"],
            "missing_behavior": "unknown signatures and API-name samples are review context only",
            "privacy_class": "path_only_no_values",
        },
        {
            "signal_id": "golden_replay.unknown_entry_count.validation_consumer",
            "parser_event_kind": "golden_replay",
            "parser_event_type": "golden_replay_report.v1",
            "raw_event_family": "fixture_validation_report",
            "raw_message_type": "",
            "normalized_payload_path": "unknowns_and_degradation.unknown_entry_count",
            "raw_payload_path": "golden replay report unknown count",
            "required_for_final": False,
            "value_source_when_used": "derived",
            "confidence_when_used": "medium",
            "finality_when_used": "final",
            "allowed_types": ["int"],
            "missing_behavior": "golden replay reports are validation consumers, not runtime truth",
            "privacy_class": "path_only_no_values",
        },
        {
            "signal_id": "feature_equity.unknown_entry_count.validation_consumer",
            "parser_event_kind": "feature_equity_corpus",
            "parser_event_type": "feature_equity_corpus_report.v1",
            "raw_event_family": "fixture_corpus_report",
            "raw_message_type": "",
            "normalized_payload_path": "unknowns_and_degradation.unknown_entries",
            "raw_payload_path": "feature-equity report unknown count",
            "required_for_final": False,
            "value_source_when_used": "derived",
            "confidence_when_used": "medium",
            "finality_when_used": "final",
            "allowed_types": ["int"],
            "missing_behavior": "feature-equity reports are corpus coverage consumers, not runtime truth",
            "privacy_class": "path_only_no_values",
        },
    ],
    "value_source_policy": {
    ...
    "degradation_behavior": [
        "missing, unreadable, malformed, or incomplete analyzed input leaves unknown_entry_count unknown or degraded",
        "numeric zero applies only to the analyzed input and is not a global no-drift claim",
        "unknown signatures, unmatched API names, and request API names are review samples, not trusted parser inputs",
        "malformed baselines, new unknown signatures, timestamp anomalies, parser exceptions, or router exceptions "
        "lower confidence and require review",
        "transport, workbook, Apps Script, deployment, analytics, model-provider output, and AI must not populate "
        "unknown_entry_count truth",
    ],
    "drift_flags": [
        "missing_expected_event_family",
        "changed_signal_type",
    ...
    "fixture_refs": [],
    "notes": [
        "Issue #171 documents unknown_entry_count provenance without changing routing or drift behavior.",
        "unknown_entry_count is derived from one analyzed input or report snapshot.",
        "A zero count is not global proof that Arena drift is absent.",
        "Unknown signatures and unmatched API names are review samples only and must not become parser truth.",
    ],
}


_TRUNCATION_COUNT_ENTRY: dict[str, Any] = {
    "entry_id": "tier6.runtime_health_and_drift_detection.truncation_count",
    "tier": 6,
    "output_family": "runtime_health_and_drift_detection",
    "output_field": "truncation_count",
    "display_name": "Truncation Count",
    "parser_owner": "src/mythic_edge_parser/parsers/truncation.py",
    "model_surface": "truncation_and_data_loss.truncation_count / TruncationEvent",
    "downstream_surfaces": [
        "parser_diagnostics_report",
        "golden_replay_report",
        "feature_equity_corpus_report",
    ...
    "direct_evidence": [
        {
            "signal_id": "parser_diagnostics.truncation_count.summary_truncation_events",
            "parser_event_kind": "parser_diagnostics",
            "parser_event_type": "parser_diagnostics.v1",
            "raw_event_family": "local_diagnostics_report",
            "raw_message_type": "",
            "normalized_payload_path": "summary.truncation_events",
            "raw_payload_path": "parser diagnostics report summary.truncation_events",
            "required_for_final": False,
            "value_source_when_used": "derived",
            "confidence_when_used": "high",
            "finality_when_used": "final",
            "allowed_types": ["int"],
            "missing_behavior": "missing truncation summary leaves truncation_count unknown",
            "privacy_class": "path_only_no_values",
        },
        {
            "signal_id": "parser_diagnostics.truncation_count.data_loss_section_count",
            "parser_event_kind": "parser_diagnostics",
            "parser_event_type": "parser_diagnostics.v1",
            "raw_event_family": "local_diagnostics_report",
            "raw_message_type": "",
            "normalized_payload_path": "truncation_and_data_loss.truncation_count",
            "raw_payload_path": "parser diagnostics report truncation_and_data_loss.truncation_count",
            "required_for_final": True,
            "value_source_when_used": "derived",
            "confidence_when_used": "high",
            "finality_when_used": "final",
            "allowed_types": ["int"],
            "missing_behavior": "missing truncation data-loss count leaves truncation_count unknown",
            "privacy_class": "path_only_no_values",
        },
        {
            "signal_id": "truncation_event.truncation_count.observed_marker",
            "parser_event_kind": "Truncation",
            "parser_event_type": "game_state_message_truncation",
            "raw_event_family": "truncation_marker",
            "raw_message_type": "GREMessageType_GameStateMessage",
            "normalized_payload_path": (
                "payload.type + payload.data_loss + payload.recoverable + payload.drift_flag"
            ),
            "raw_payload_path": "explicit GameStateMessage truncation marker",
            "required_for_final": False,
            "value_source_when_used": "observed",
            "confidence_when_used": "high",
            "finality_when_used": "live",
            "allowed_types": ["str", "bool"],
            "missing_behavior": "absence of observed markers only describes the analyzed input",
            "privacy_class": "path_only_no_values",
        },
        {
            "signal_id": "truncation_event.truncation_count.marker_metadata",
            "parser_event_kind": "Truncation",
            "parser_event_type": "game_state_message_truncation",
            "raw_event_family": "truncation_marker",
            "raw_message_type": "GREMessageType_GameStateMessage",
            "normalized_payload_path": "payload.game_object_count + payload.annotation_count",
            "raw_payload_path": "explicit truncation marker metadata counts",
            "required_for_final": False,
            "value_source_when_used": "observed",
            "confidence_when_used": "medium",
            "finality_when_used": "live",
            "allowed_types": ["int", "unknown"],
            "missing_behavior": "marker metadata is context only and does not reconstruct omitted GameState data",
            "privacy_class": "path_only_no_values",
        },
    ],
    "fallback_evidence": [
        {
            "signal_id": "golden_replay.truncation_count.validation_consumer",
            "parser_event_kind": "golden_replay",
            "parser_event_type": "golden_replay_report.v1",
            "raw_event_family": "fixture_validation_report",
            "raw_message_type": "",
            "normalized_payload_path": "truncation_and_data_loss.truncation_count",
            "raw_payload_path": "golden replay report truncation count",
            "required_for_final": False,
            "value_source_when_used": "derived",
            "confidence_when_used": "medium",
            "finality_when_used": "final",
        ...
        {
            "signal_id": "feature_equity.truncation_count.validation_consumer",
            "parser_event_kind": "feature_equity_corpus",
            "parser_event_type": "feature_equity_corpus_report.v1",
            "raw_event_family": "fixture_corpus_report",
            "raw_message_type": "",
            "normalized_payload_path": (
                "truncation_and_data_loss.truncation_events + data_loss_markers + fixtures_with_truncation"
            ),
            "raw_payload_path": "feature-equity report truncation and data-loss counts",
            "required_for_final": False,
            "value_source_when_used": "derived",
            "confidence_when_used": "medium",
            "finality_when_used": "final",
            "allowed_types": ["int", "list"],
            "missing_behavior": "feature-equity reports are corpus coverage consumers, not runtime truth",
            "privacy_class": "path_only_no_values",
        },
    ],
    ...
    "degradation_behavior": [
        "numeric zero applies only to the analyzed input and does not prove no GameState data loss elsewhere",
        "positive truncation count proves data-loss markers were observed, not that omitted GameState data recovered",
        "truncation markers do not reconstruct omitted objects, annotations, zones, actions, timers, winners, "
        "or hidden facts",
        "missing, malformed, unrouted, or summarized source evidence leaves truncation_count unknown or degraded",
        "truncation/data-loss evidence may lower confidence for dependent parser facts in future field-evidence work, "
        "but issue #171 does not implement field-evidence attachment",
        "analytics, model-provider output, AI, workbook formulas, dashboards, webhook transport, and Apps Script "
        "must not recover missing GameState data",
    ],
    "drift_flags": [
        "missing_expected_payload_path",
        "changed_signal_type",
    ...
    "fixture_refs": [],
    "notes": [
        "Issue #171 documents truncation_count provenance without changing truncation parsing or router dispatch.",
        "Truncation markers are observed parser-owned data-loss evidence.",
        "truncation_count is a count of observed markers or diagnostics summaries for one analyzed input.",
        "Truncation evidence does not reconstruct missing GameState payloads, objects, annotations, zones, "
        "actions, timers, hidden cards, or gameplay facts.",
    ],
}
