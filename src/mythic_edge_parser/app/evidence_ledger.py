...
_OUTPUT_FAMILIES: tuple[dict[str, Any], ...] = (
    {
        ...
        "notes": [
            ...
            "Derived aggregate workbook fields remain deferred until a later contract.",
        ],
    },
    {
        "tier": 2,
...
_MATCH_RESULT_ENTRY: dict[str, Any] = {
    ...
    "fixture_refs": [],
    "notes": [
        "Documents derived win/loss provenance; participant provenance remains outside issue #130.",
    ],
}
