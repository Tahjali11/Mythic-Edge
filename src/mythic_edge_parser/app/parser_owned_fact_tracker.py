...
SYNTHETIC_SOURCE_KINDS = ("synthetic_fixture", "synthetic_player_log", "synthetic_utc_log")
PRIVATE_SOURCE_KINDS = ("user_selected_player_log", "user_selected_normalized_utc_log")
