...
try:
    ...
    from tools.check_agent_docs_models import CheckResult, Finding, Reference
    from tools.check_agent_docs_report import render_json, render_report
    ...
    from check_agent_docs_models import CheckResult, Finding, Reference
    from check_agent_docs_report import render_json, render_report
